...
const Auth: React.FC = () => {
    ...
    return (
        <div className="flex-1 min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
                ...
                {!isAdmin && (
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            className="w-full bg-blue-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200"
                        >
                            Giriş Yap
                        </button>
                    </form>
                ...
                <div className="mt-6 text-center">
                    <p className="text-sm text-gray-600">
                        {isAdmin ? 'Admin paneli' : 'Kullanıcı paneli'} için giriş yapıyorsunuz
                    </p>
                </div>
